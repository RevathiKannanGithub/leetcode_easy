...
class Solution:
    ...
    # list2 = ["Piatti","The Grill at Torrey Pines","Hungry Hunter Steakhouse","Shogun"]
        ...
        for i in range(len(list1)):
            # list1[i] = "Shogun"
            # list1[i] = "Tapioca Express"
            # list1[i] = "Burger King"
            # list1[i] = "KFC"
          
            for j in range(len(list2)):
                # list2[j] = "Piatti"
                # list2[j] = "The Grill at Torrey Pines"
                # list2[j] = "Hungry Hunter Steakhouse"
                # list2[j] = "Shogun"
              
                if list1[i] == list2[j]:
                    # list1[i] = "Shogun" = list2[j]
                    sum_index = i+j
                    # sum_index = 0+3 = 3
                    # sum_index = 3
                    # min_sum_index = positive infinity
                  
                    if sum_index < min_sum_index:
                        # sum_index < min_sum_index'
